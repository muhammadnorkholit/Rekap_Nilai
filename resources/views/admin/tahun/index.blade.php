            ...
            <div class="col">
                <div class="card shadow">
                    <div class="card-header bg-transparent border-0">
                        <a href="/admin/panel/tahun_ajaran/create" class="btn btn-primary">Tambah data</a>
                    </div>
                        ...
                        <table class="table align-items-center table-light table-flush">
                            <thead class="thead-light" style="color: text-white;">
                                <tr>
                                    ...
                                    <th scope="col" class="sort">Tahun Ajaran</th>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a class="btn btn-info"
                                                href="/admin/panel/tahun_ajaran/{{ $t->id }}/edit"><i
                                                    class="fa fa-edit"></i></a>
                                            <button type="button" class="btn btn-warning" data-toggle="modal"
                                                data-target="#hapus{{ $t->id }}"><i class="fa fa-trash"></i></button>
                                        </td>

                                        {{-- delete --}}
                                        <form action="/admin/panel/tahun_ajaran/{{ $t->id }}" method="POST">
                                            @method('DELETE')
                                            @csrf
                                                    ...
                                                    <div class="modal-content bg-gradient-danger">
                                                        ...
                                                        <div class="modal-body">
                                                            <div class="py-3 text-center">
                                                                ...
                                                                <h4 class="heading mt-4">Anda yakin akan hapus Tahun Ajaran
                                                                    {{ $t->tahun }} ??</h4>
