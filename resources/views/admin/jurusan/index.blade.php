                            ...
                            <tbody class="list">
                                @foreach ($jurusan as $j)
                                    <tr>
                                        ...
                                        <td>
                                            <a class="btn btn-info" href="/admin/panel/jurusan/{{ $j->id }}/edit">edit</a>
                                            <button type="button" class="btn btn-warning" data-toggle="modal" data-target="#hapus{{ $j->id }}">Hapus</button>
                                        </td>
                                        ...
                                        <form action="/admin/panel/jurusan/{{ $j->id }}" method="POST">
                                            @method('DELETE')
                                            @csrf
                                                <div class="modal fade" id="hapus{{ $j->id }}" tabindex="-1" role="dialog" aria-labelledby="modal-notification" aria-hidden="true">
                                                        <div class="modal-dialog modal-danger modal-dialog-centered modal-" role="document">
                                                        <div class="modal-content bg-gradient-danger">
                                                            <div class="modal-header">
                                                            <h6 class="modal-title" id="modal-title-notification">{{ $j->jurusan}}</h6>
                                                            ...
                                                            <div class="py-3 text-center">
                                                                ...
                                                                <h4 class="heading mt-4">Anda yakin akan hapus, {{$j->jurusan}} ??</h4>
